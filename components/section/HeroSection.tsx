      ...
      <div className="container mx-auto px-0 lg:px-0">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8">
          ...
          <div className="w-full lg:w-[70%] text-center sm:text-left pr-0 lg:pr-4 mt-6 lg:mt-0">
            {/* Hidden H1 for SEO - contains main keywords */}
            <h1 className="sr-only">Aufa | Aufa Dzakiy - Full-Stack Developer & UI/UX Designer Terbaik Indonesia | Portfolio Aufa</h1>
            ...
            >
              Perkenalkan, saya <strong>Aufa Dzakiy</strong> (biasa dipanggil <strong>Aufa</strong>). Saya bersemangat dalam menciptakan solusi digital yang utuh, dengan mengintegrasikan antarmuka pengguna yang intuitif dengan logika back-end yang andal dan berperforma tinggi.
            </p>
