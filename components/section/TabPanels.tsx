...
export default function TabPanels({ active }: Props) {
  ...
  const SKILL_DESCRIPTIONS: Record<string, string> = {
    ...
    JavaScript:
      "Scripting language for interactivity and logic in the browser.",
    ...
    Bootstrap:
      "CSS framework for responsive, mobile-first projects with prebuilt components and utilities.",
    ...
    Canva:
      "Design tool for creating graphics, social media assets, and lightweight UI mockups.",
  };
