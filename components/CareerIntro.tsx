...
const CareerIntro: React.FC = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center px-6 py-0 pt-14 pb-8 lg:pt-0 lg:pb-0 lg:px-8 lg:py-18 overflow-hidden bg-gradient-to-b from-[#DEE9FF] via-white to-white">
