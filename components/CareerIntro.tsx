...
const CareerIntro: React.FC = () => {
  return (
    <section className="relative flex flex-col justify-center items-start px-6 py-24 md:py-44 lg:py-30 pb-12 lg:pb-45 lg:px-8 overflow-hidden bg-linear-to-b from-[#DEE9FF] via-white to-white">
      ...
      <div className="absolute inset-0 z-0 opacity-30">
        <motion.div 
          ...
          className="absolute top-20 right-10 w-64 h-64 lg:w-96 lg:h-96 bg-linear-to-br from-[#0253EE]/20 to-[#011C4F]/10 rounded-full blur-3xl"
        />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-8 lg:space-y-12">
        ...
        >
          ...
          Dari <span className="bg-linear-to-r from-[#0253EE] to-[#011C4F] bg-clip-text text-transparent">Mahasiswa</span> hingga <span className="bg-linear-to-r from-[#0253EE] to-[#011C4F] bg-clip-text text-transparent">Developer Profesional</span>
        </motion.h2>
        ...
        >
          <div className="text-center">
            <div className="text-3xl lg:text-5xl font-bold bg-linear-to-r from-[#0253EE] to-[#011C4F] bg-clip-text text-transparent mb-2">
              2+
            </div>
